...
class Symfony extends Framework implements DoctrineProvider, PartedModule
{
     ...
     *
     * EM services is retrieved once and then that instance returned on each call
     */
    ...
    /**
     * Get services $serviceName and add it to the lists of persistent services.
     * If $isPermanent then services becomes persistent between tests
     *
    ...
    /**
     * Remove services $serviceName from the lists of persistent services.
     *
     * @param string $serviceName
     */
    ...
    /**
     * Grabs a services from Symfony DIC container.
