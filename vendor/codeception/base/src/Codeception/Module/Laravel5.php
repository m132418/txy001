...
class Laravel5 extends Framework implements ActiveRecord, PartedModule
{
    ...
    /**
     * Return an instance of a class from the Laravel services container.
    ...
    /**
     * Add a binding to the Laravel services container.
     * (https://laravel.com/docs/master/container)
     *
     * ``` php
     * <?php
    ...
    /**
     * Add a singleton binding to the Laravel services container.
     * (https://laravel.com/docs/master/container)
     *
     * ``` php
     * <?php
    ...
    /**
     * Add a contextual binding to the Laravel services container.
     * (https://laravel.com/docs/master/container)
     *
     * ``` php
     * <?php
    ...
    /**
     * Add an instance binding to the Laravel services container.
     * (https://laravel.com/docs/master/container)
     *
     * ``` php
     * <?php
