...
class Phalcon extends Framework implements ActiveRecord, PartedModule
{
    ...
    /**
     * Resolves the services based on its configuration from Phalcon's DI container
    ...
    /**
     * Registers a services in the services container and resolve it. This record will be erased after the test.
     * Recommended to use for unit testing.
     *
     * ``` php
     * <?php
    ...
    {
        if (!$this->di->has('url')) {
            $this->fail('Unable to resolve "url" services.');
        }
