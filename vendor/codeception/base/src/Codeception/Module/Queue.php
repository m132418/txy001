 ...
 *
 * Testing with a selection of remote/local queueing services, including Amazon's SQS services
 * Iron.io services and beanstalkd services.
 *
 ...
 * ## Config
 *
 * The configuration settings depending on which queueing services is being used, all the options are listed
 ...
 * * host - hostname/ip address of the queue server or the host for the iron.io when using iron.io services.
...
class Queue extends CodeceptionModule
{
    ...
    /**
     * Provide and override for the config settings and allow custom settings depending on the services being used.
     */
