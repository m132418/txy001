...
class Laravel5 extends Client
{
    ...
    private function initialize($request = null)
    {
        ...
        // This way other services providers that rely on the $app['db'] entry
    ...
    /**
     * Apply the registered Laravel services container bindings.
     */
    ...
    /**
     * Apply the registered Laravel services container contextual bindings.
     */
    ...
    /**
     * Apply the registered Laravel services container instance bindings.
     */
    ...
    /**
     * Register a Laravel services container binding that should be applied
    ...
    /**
     * Register a Laravel services container contextual binding that should be applied
     * after initializing the Laravel Application object.
     *
     * @param $concrete
     * @param $abstract
    ...
    /**
     * Register a Laravel services container instance binding that should be applied
     * after initializing the Laravel Application object.
     *
     * @param $abstract
     * @param $instance
