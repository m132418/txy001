...
class RegisterListenersPassTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @expectedException \InvalidArgumentException
     * @expectedExceptionMessage The services "foo" must be public as event listeners are lazy-loaded.
     */
    ...
    /**
     * @expectedException \InvalidArgumentException
     * @expectedExceptionMessage The services "foo" must be public as event subscribers are lazy-loaded.
     */
    ...
    /**
     * @expectedException \InvalidArgumentException
     * @expectedExceptionMessage The services "foo" must not be abstract as event listeners are lazy-loaded.
     */
    ...
    /**
     * @expectedException \InvalidArgumentException
     * @expectedExceptionMessage The services "foo" must not be abstract as event subscribers are lazy-loaded.
     */
