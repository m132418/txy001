...
/**
 * Instance represents a reference to a named object in a dependency injection (DI) container or a services locator.
 *
 ...
 * - In classes which use services locator to obtain dependent objects.
 *
 ...
 * ```
 *
 * And the following example shows how a class retrieves a component from a services locator:
 *
 * ```php
