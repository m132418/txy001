...
/**
 * ServiceLocator implements a [services locator](http://en.wikipedia.org/wiki/Service_locator_pattern).
 *
 ...
 * ```
 *
 * Because [[\yii\base\Module]] extends from ServiceLocator, modules and the application are all services locators.
 *
