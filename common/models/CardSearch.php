...
class CardSearch extends Card
{
    ...
    {
        return [
            [['id', 'refapp', 'status', 'period', 'created_at', 'updated_at', 'bind_at', 'bind_uid', 'whoissue'], 'integer'],
            [['sn'], 'safe'],
        ];
    }
    ...
    {
        $query = Card::find()->orderBy(['status' => SORT_ASC, 'created_at' => SORT_DESC]);
...
//             'whoissue' => $this->whoissue,
            'whoissue' => Yii::$app->user->identity->id,
